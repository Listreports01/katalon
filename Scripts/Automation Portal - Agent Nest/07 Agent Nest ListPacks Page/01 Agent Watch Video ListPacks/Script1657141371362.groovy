...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  ListPacks/Watch Video ListPacks'))

WebUI.delay(10)

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  ListPacks/X Watch Video ListPacks'))
