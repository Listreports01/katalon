...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Shareables library/Share Notable Shareables'))

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Shareables/Notable to Share'))

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Shareables/Select Notable to Share'))

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Shareables/Notable to Share Option 2'))
