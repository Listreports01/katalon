...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables library/div_22'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables library/div_22'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables library/div_Awesome agentViewFelicitar un nacimient_77c965'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables library/div_Special Occasions'))
