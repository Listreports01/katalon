...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables library/div_Weekly Talking Points_MuiBox-root jss606'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables/h1_Shareables'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables/div_Notable'))
