...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Shareables library/Share Special Occasions Shareables'))

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Shareables/Select Occasion drpdown'))

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Shareables/Download'))
