...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Shareables library/View Todays Notable'))

WebUI.verifyElementVisible(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Shareables/Shareables Text'))
