...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables library/div_16'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables library/div_16'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables library/div_ViewViewViewViewViewViewViewViewViewVie_d68497'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ListReports  Shareables library/div_ListPacks'), 0)
