...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Home/div_ShareablesView allTodays ShareableShare_bb5208'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  Home/Shareables Page'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables library/Browse Shareables Text'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables library/div_Daily_MuiBox-root jss836'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables library/div_Daily_MuiBox-root jss836'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Shareables/div'))
