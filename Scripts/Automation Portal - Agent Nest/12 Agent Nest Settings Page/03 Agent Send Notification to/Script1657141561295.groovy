...
WebUI.click(findTestObject('Object Repository/Automation Portal - Agent Nest/Page_ListReports  Home/Settings Page'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Settings/Settings Text'))

WebUI.setText(findTestObject('Object Repository/Page_ListReports  Settings/input_Tip_email_alias'), 'mn.flores@listreports.com')

WebUI.click(findTestObject('Object Repository/Page_ListReports  Settings/button_Add'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Settings/span_Alias added successfully'), 
    0)
