...
WebUI.click(findTestObject('Object Repository/Automation Portal - Agent Nest/Page_ListReports  Home/Contact Us Page'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_ListReports  Contact Us/Contact Us Text'))

WebUI.selectOptionByIndex(findTestObject('Object Repository/Page_ListReports  Contact Us/select_I need to submit a general support t_d8a083'), 
    '1', FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Contact Us/strong_Whats on your mind'), 
    0)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Contact Us/h2_Thanks'), 0)
