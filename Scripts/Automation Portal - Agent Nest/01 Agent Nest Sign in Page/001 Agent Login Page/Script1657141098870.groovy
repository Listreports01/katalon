...
WebUI.setText(findTestObject('Automation Portal - Vendor Nest/Page_ListReports  Login/Vendor Nest Email Address'), GlobalVariable.AgentNestUser)

WebUI.setText(findTestObject('Automation Portal - Vendor Nest/Page_ListReports  Login/Vendor Nest Password'), GlobalVariable.DecryptPass)
