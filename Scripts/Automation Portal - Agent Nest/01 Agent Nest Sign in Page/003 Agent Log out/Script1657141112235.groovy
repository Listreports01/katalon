...
WebUI.setText(findTestObject('Automation Portal - Vendor Nest/Page_ListReports  Login/Vendor Nest Email Address'), GlobalVariable.VendorNestEmail)
...
WebUI.click(findTestObject('Automation Portal - Vendor Nest/Page_ListReports  Home/Automation Vendor Nest'))

WebUI.click(findTestObject('Automation Portal - Vendor Nest/Page_ListReports  Home/Vendor Nest Logout'))
