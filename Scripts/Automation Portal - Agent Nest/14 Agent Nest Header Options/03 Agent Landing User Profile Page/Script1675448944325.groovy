...
WebUI.waitForElementPresent(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Home/ListReports Greetings'), 
    0)
...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Home/Automation Agent Nest Profile'))

WebUI.verifyElementVisible(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Edit Profile/Profile Text'))
