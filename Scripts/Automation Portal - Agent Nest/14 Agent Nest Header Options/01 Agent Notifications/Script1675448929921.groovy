...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Home/Notifications'))

WebUI.verifyElementVisible(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Home/Notifications Text'))
