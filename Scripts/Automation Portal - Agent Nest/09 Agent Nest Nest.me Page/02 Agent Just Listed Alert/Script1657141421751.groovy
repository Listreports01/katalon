...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Home/Nest.me Page'))

WebUI.verifyElementVisible(findTestObject('Automation Portal - Agent Nest/Page_ListReports  nest.me/NestText'))

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  nest.me/Just Listed Alert btn'))

WebUI.verifyElementVisible(findTestObject('Automation Portal - Agent Nest/Page_ListReports  nest.me/Just Listed Form'))
