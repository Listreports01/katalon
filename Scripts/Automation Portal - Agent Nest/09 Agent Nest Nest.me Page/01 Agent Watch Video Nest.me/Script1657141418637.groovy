...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  nest.me/Nest.me Watch Video'))

WebUI.delay(10)

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  nest.me/Close Watch video Nest me'))
