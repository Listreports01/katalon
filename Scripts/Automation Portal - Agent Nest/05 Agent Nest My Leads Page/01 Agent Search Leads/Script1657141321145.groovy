...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Home/My Leads Page'))

WebUI.verifyElementVisible(findTestObject('Automation Portal - Agent Nest/Page_ListReports  My Leads/My Leads Text'))

WebUI.setText(findTestObject('Automation Portal - Agent Nest/Page_ListReports  My Leads/Searchbox Leads'), 'Leads')

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  My Leads/Search Leads'))
