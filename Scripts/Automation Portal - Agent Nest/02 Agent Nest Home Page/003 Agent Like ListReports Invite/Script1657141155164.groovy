...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Home/Invite a user'))

WebUI.verifyElementVisible(findTestObject('Automation Portal - Agent Nest/Page_ListReports  ARBA/Invite your agent colleagues'))
