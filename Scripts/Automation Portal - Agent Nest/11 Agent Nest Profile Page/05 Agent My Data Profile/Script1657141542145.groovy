...
WebUI.verifyElementVisible(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Edit Profile/Profile My Data'))

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Edit Profile/Profile My Data'))
