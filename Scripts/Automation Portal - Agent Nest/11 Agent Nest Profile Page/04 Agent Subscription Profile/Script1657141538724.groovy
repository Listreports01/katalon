...
WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Home/Profile Page'))

WebUI.verifyElementVisible(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Edit Profile/Profile Text'))

WebUI.click(findTestObject('Automation Portal - Agent Nest/Page_ListReports  Edit Profile/Profile Subscriptions'))
