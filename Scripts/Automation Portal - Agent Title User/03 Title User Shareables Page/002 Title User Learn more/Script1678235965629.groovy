...
WebUI.click(findTestObject('Object Repository/Automation Portal - Title User/Page_ListReports  Shareables library/span_Learn more'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Automation Portal - Title User/Page_ListReports  Select your Loan Officer/p_Pair with a loan officer to unlock all features'), 
    0)
