...
WebUI.click(findTestObject('Object Repository/Automation Portal - Title User/Page_ListReports  Shareables library/div_Special Occasions_MuiBox-root jss335'))
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Automation Portal - Title User/Page_ListReports  Shareables/h3_Choose a fun fact'), 
    0)
