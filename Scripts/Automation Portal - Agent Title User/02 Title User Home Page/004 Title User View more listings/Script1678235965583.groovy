...
WebUI.click(findTestObject('Object Repository/Automation Portal - Title User/Page_ListReports  Home/b_View more listings'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Automation Portal - Title User/Page_ListReports  ListPacks/span_Total Listings'), 
    0)
