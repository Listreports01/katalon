...
WebUI.click(findTestObject('Object Repository/Automation Portal - Title User/Page_ListReports  Home/p_Knowledge base'))

WebUI.navigateToUrl('https://help.listreports.com/')

WebUI.waitForElementPresent(findTestObject('Object Repository/Automation Portal - Title User/Page_ListReports Knowledge Base/h2_How can we help'), 
    0)
