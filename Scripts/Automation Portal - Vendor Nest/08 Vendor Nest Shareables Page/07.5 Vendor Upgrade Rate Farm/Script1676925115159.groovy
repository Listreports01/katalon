...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables/span_Upgrade now'))

WebUI.delay(7)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables/button_Cancel'))
