...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables library/div_Category'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables library/span_Select all'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Shareables library/span_Reset'))
