...
WebUI.click(findTestObject('Object Repository/Page_ListReports  My Agents/span_Follow Agent'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  My Agents/span_Follow Agent'), 0)

WebUI.setText(findTestObject('Object Repository/Page_ListReports  My Agents/input_Follow Agent_autocompleteSearch'), 'Marbz')

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_ListReports  My Agents/button_Select'))

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_ListReports  My Agents/span_Follow'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  My Agents/h2_Congrats'), 0)

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_ListReports  My Agents/button_Ok'))
