...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Edit Profile/h3_Subscriptions'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Edit Profile/h2_subscriptions'), 0)

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Edit Profile/h2_Past transactions'), 0)
