...
WebUI.setText(findTestObject('Object Repository/Page_ListReports  Edit Profile/textarea_Bio_bio'), 'Test')

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Edit Profile/h2_2. Additional Info'), 0)

WebUI.setText(findTestObject('Object Repository/Page_ListReports  Edit Profile/textarea_Testimonial_quote_body'), 'Test')

WebUI.click(findTestObject('Object Repository/Page_ListReports  Edit Profile/button_Save'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Edit Profile/h2_Thanks'), 0)
