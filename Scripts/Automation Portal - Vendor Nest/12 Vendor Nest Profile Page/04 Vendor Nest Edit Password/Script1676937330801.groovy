...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Edit Profile/h3_Password'))

WebUI.delay(3)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ListReports  Edit Profile/input_Forgot Password_currentPassword'), 
    'iEyxPcxw54Vp44aspd/iJQ==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ListReports  Edit Profile/input_New Password_password'), 'iEyxPcxw54Vp44aspd/iJQ==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ListReports  Edit Profile/input_Confirm Password_confirm'), 
    'iEyxPcxw54Vp44aspd/iJQ==')

WebUI.click(findTestObject('Object Repository/Page_ListReports  Edit Profile/button_Save'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Edit Profile/h2_Congrats'), 0)

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Edit Profile/button_Ok'))
