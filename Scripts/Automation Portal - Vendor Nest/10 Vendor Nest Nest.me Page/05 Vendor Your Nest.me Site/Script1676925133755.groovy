...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  nest.me/h2_Your nest.me site'), 0)

WebUI.switchToWindowTitle('ListReports | nest.me')

WebUI.click(findTestObject('Object Repository/Page_ListReports  nest.me/button_YOUR NEST.ME SITE'))

WebUI.navigateToUrl('https://nest.stage.listreports.com/qatest.lo3')

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_nest.me by ListReports/h1_Search. Save. Get Alerts'), 
    0)
