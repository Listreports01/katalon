...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Home/h2_Happy Monday, Automation . Heres your da_3621ad'), 
    0)

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Home/h3_Shareables'), 0)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Home/b_View all'))
