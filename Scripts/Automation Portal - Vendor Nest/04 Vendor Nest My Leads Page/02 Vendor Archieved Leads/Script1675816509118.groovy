...
WebUI.click(findTestObject('Object Repository/Page_ListReports  My Agents/button_My Leads'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  My Leads/h1_My Leads'), 0)

WebUI.delay(2)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_ListReports  My Leads/select_All leadsArchived Leads'), 
    'archived', true)
