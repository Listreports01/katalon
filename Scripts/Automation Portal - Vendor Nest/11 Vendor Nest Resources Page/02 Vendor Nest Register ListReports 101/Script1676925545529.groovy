...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Resources/h1_ListReports 101 Keys to Success'), 
    0)

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Resources/span_Register'))

WebUI.switchToWindowUrl('https://listreports.zoom.us/webinar/register/WN_fnWIrFkFSliBKC4JyzuZJg')

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Webinar Registration - Zoom/strong_Loan Officer 101'), 
    0)
