...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Agent education tools/h1_Agent value presentation'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Agent education tools/div_Share'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Agent education tools/button_Copy Link'))
