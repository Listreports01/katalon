...
WebUI.click(findTestObject('Page_ListReports  Resources/a_Register_1'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Webinars/h2_Webinars'), 0)
