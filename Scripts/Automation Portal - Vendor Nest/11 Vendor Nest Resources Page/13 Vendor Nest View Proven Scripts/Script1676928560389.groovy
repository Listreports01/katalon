...
WebUI.switchToWindowUrl('https://welcome.listreports.com/help-docs')

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports Help Docs  ListReports/h1_ListReports Help Docs'), 
    0)
