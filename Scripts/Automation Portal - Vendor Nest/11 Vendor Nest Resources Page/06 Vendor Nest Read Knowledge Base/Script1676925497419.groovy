...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Resources/h2_Knowledge Base'), 0)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Resources/span_Read'))

WebUI.switchToWindowUrl('https://help.listreports.com/article-categories/using-listreports-lenders/')

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Using ListReports  ListReports Knowledge Base/div_ListReports Knowledge Base'), 
    0)
