...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Settings/h2_My market'), 0)

WebUI.setText(findTestObject('Object Repository/Page_ListReports  Settings/input_My market_autocompleteSearch'), '90001')
