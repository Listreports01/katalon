...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Settings/h3_Automation'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Settings/span_AutoPilot'), 0)

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Settings/md-switch_AutoPilot_ng-pristine ng-untouche_711273'))
