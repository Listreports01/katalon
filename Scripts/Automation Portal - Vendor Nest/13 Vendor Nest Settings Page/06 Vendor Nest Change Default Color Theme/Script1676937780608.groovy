...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Settings/div_Personalize your marketing material by _79ae95'), 
    0)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_ListReports  Settings/select_ListReports Blue (Default)Baird  War_f7482d'), 
    '0', true)
