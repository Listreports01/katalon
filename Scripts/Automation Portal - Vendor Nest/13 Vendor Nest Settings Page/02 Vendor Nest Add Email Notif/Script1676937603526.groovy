...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Settings/h2_Send notifications to'), 0)

WebUI.setText(findTestObject('Object Repository/Page_ListReports  Settings/input_Tip_email_alias'), 'mn.flores+agentnest@listreports.com')

WebUI.click(findTestObject('Object Repository/Page_ListReports  Settings/button_Add'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Settings/h2_Congrats'), 0)
