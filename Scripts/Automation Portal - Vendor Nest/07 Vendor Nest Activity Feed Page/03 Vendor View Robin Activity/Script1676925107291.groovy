...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Home/h3_Paired agent activity'), 0)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Home/button_Activity Feed'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  Activity Feed/span_Activity Feed'), 0)
