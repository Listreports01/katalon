...
WebUI.click(findTestObject('Object Repository/Page_Shop by ListReports/a_Shop Now'))

WebUI.navigateToUrl('https://shop.listreports.com/shop')

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Shop Now  Shop by ListReports/h2_Shop by ListReports'), 
    0)
