...
WebUI.navigateToUrl('https://shop.listreports.com/')

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_Shop by ListReports/a_FAQ'))

WebUI.switchToWindowUrl('https://shop.listreports.com/faq')

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_FAQ  Shop by ListReports/h2_FAQ'), 0)
