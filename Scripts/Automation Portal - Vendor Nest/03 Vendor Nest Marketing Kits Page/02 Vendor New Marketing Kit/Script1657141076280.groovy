...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  New ListReport/label_Property Address'), 
    0)

WebUI.setText(findTestObject('Object Repository/Page_ListReports  New ListReport/input__autocompleteSearch'), 'Marbz')

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  New ListReport/div_Marbz 3022Test Emailmn.flores3022listre_f7f104'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_ListReports  New ListReport/button_Select'))

WebUI.setText(findTestObject('Object Repository/Page_ListReports  New ListReport/input_Property Address_address'), '90001')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  New ListReport/h2_Congratulations'), 0)

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_ListReports  New ListReport/button_Ok'))
