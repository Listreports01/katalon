...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Marketing Kits/button_View'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Page_ListReports  View Report/h3_Marketing Kit for'), 0)

WebUI.click(findTestObject('Object Repository/Page_ListReports  View Report/button_Edit'))
...
WebUI.setText(findTestObject('Object Repository/Page_ListReports  Edit Report/textarea_This will appear on all flyers and_56e21a'), 
    'test')
