...
WebUI.click(findTestObject('Automation Portal - Vendor Nest/Page_ListReports  Marketing Kits/Vendor Nest View Pending Invites1'))

WebUI.verifyElementVisible(findTestObject('Automation Portal - Vendor Nest/Page_ListReports  My Agents/Vendor Nest My Agent Text'))
