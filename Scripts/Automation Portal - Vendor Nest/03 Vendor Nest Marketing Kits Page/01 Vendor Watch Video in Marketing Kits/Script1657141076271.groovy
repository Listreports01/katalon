...
WebUI.click(findTestObject('Automation Portal - Vendor Nest/Page_ListReports  Marketing Kits/Vendor Nest Marketing Kit Watch Video'))

WebUI.delay(10)

WebUI.click(findTestObject('Automation Portal - Vendor Nest/Page_ListReports  Marketing Kits/Vendor Nest Marketing Kit Close Video'))
