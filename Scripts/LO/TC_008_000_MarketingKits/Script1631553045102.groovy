...
WebUI.verifyElementText(findTestObject('Object Repository/Page_ListReports  Marketing Kits/span_Marketing Kits'), 'Marketing Kits')

WebUI.click(findTestObject('Object Repository/Page_ListReports  Marketing Kits/span_Watch Video'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  Marketing Kits/i_Mozilla Firefox_lr lr-times lr-lg clickable'))
