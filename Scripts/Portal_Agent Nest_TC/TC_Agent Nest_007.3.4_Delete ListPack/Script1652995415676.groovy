...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  ListPacks/My ListPacks_Delete button'))

WebUI.click(findTestObject('Marbz Portal/Page_ListReports  ListPacks/My ListPacks_Delete ListPacks_Yes'))

WebUI.delay(5)

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  ListPacks/My ListPacks_ has been deleted'))

WebUI.click(findTestObject('Marbz Portal/Page_ListReports  ListPacks/My ListPacks_Ok'))
