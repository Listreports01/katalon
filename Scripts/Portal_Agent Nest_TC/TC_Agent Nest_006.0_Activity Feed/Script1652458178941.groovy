...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Home/Activity Feed_click'))

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Activity Feed/Activity Feeds_Verify Text'))
