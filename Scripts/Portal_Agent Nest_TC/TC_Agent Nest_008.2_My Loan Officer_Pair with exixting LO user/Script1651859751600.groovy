...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Select your Loan Officer/My Loan Officer_Invite someone else_Select'))

WebUI.delay(3)

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Select your Loan Officer/My Loan Officer_Invite someone else_Youve invited_Verify Text'))

WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Select your Loan Officer/My Loan Officer_Invite someone else_Im interested_radio button'))

WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Select your Loan Officer/My Loan Officer_Invite someone else_Submit_button'))

WebUI.delay(5)

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Select your Loan Officer/My Loan Officer_Invite someone else_Invite sent_Verify Text'))
