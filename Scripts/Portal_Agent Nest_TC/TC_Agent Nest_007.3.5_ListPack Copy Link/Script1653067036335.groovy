...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  ListPack/My ListPacks_View_Copy Link'))

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  ListPack/My ListPacks_View_Copy Link'), FailureHandling.STOP_ON_FAILURE)
