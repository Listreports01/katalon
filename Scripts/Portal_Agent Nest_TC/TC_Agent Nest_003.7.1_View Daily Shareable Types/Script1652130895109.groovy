...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_Daily Type_Tab'))

WebUI.delay(3)

WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_Daily Types_View all'))

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_Daily Types_Categories_Verify Text'))
