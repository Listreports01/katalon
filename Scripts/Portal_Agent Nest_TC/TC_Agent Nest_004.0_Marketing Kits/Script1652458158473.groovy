...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Home/Marketing Kits_click'))

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Marketing Kits/Marketing Kits_Verify Text'))
