...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_Share now_Notable_'))

WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Shareables/Shareables_Color_dropdown_1'))

WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Shareables/Shareables_Color_Ocean_dropdown'))
...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Shareables/Shareables_Copy a Caption'))
