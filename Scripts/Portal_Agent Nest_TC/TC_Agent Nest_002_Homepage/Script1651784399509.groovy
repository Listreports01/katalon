...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Home/Home_Button'))

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Home/List Reports_Logo_Verify Text'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Home/Home_Greet Text_Verify Text'), FailureHandling.STOP_ON_FAILURE)
