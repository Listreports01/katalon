...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_Special Occasions Type'))

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_My Listing_Categories_Verify Text'))
