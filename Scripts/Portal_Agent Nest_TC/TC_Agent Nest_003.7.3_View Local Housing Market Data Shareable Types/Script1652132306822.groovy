...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_Local Housing Market Data Type_Tab'))

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_Local Housing Market Data Type_Categories'))
