...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Home/My Leads_click'))

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  My Leads/My Leads_Verify Text'))
