...
WebUI.click(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_ListPacks Type_Tab'))

WebUI.verifyElementVisible(findTestObject('Marbz Portal/Page_ListReports  Shareables library/Shareables_ListPacks Type_Categories_Verify Text'))
