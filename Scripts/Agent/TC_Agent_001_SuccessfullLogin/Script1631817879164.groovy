...
WebUI.verifyElementText(findTestObject('Page_ListReports  Login/div_Hello, there Lets get you logged in.   _8a844d'), 'Please enter both email and password to sign in.')
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_ListReports  Login/input_Password_password'), 'iEyxPcxw54VotCcg0+301w==')

WebUI.click(findTestObject('Object Repository/Page_ListReports  Login/button_Submit'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_ListReports  Login/p_Invalid login. Please try again'), 'Invalid login. Please try again.')
