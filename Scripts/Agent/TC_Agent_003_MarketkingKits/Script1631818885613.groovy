...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Home/span_Marketing Kits_1'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ListReports  Marketing Kits/span_Marketing Kits'), 0)

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_ListReports  New ListReport/button_New Marketing Kit'))
