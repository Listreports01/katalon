...
WebUI.click(findTestObject('Object Repository/Page_ListReports  ListPacks/svg_View_MuiSvgIcon-root'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListPacks/span_Delete'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListPacks/div_Yes, delete'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListPacks/div_Ok'))
