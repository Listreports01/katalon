...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ListReports  ListPacks/a_My Listpacks'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ListReports  ListPacks/a_Live ListPacks'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ListReports  ListPacks/a_Property Search'), 0)
