...
WebUI.click(findTestObject('Object Repository/Page_ListReports  My Leads/svg_View_MuiSvgIcon-root'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  My Leads/span_Archive'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  My Leads/span_Yes'))
