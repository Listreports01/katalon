...
WebUI.click(findTestObject('Object Repository/Page_ListReports  Home/button_My Loan Officer'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ListReports  My Loan Officer/span_My Loan Officer'), 0)

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_ListReports  My Loan Officer/button_Change'))
