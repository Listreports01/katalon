...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_ListReports  ListReports Live/select_Use my virtual meeting roomSchedule _9917ad'), 
    'Virtual Meeting Room', true)

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/b_COPY CAPTION'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/span_Copy guest link'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/span_Send'))

WebUI.setText(findTestObject('Object Repository/Page_ListReports  ListReports Live/input_concat(Recipient, , s name)_MuiBox-ro_9eaccf'), 
    'Marben Flores')

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/span_Add new'))

WebUI.setText(findTestObject('Object Repository/Page_ListReports  ListReports Live/input_Email_email'), 'mn.flores@listreports.com')

WebUI.setText(findTestObject('Object Repository/Page_ListReports  ListReports Live/input_Mobile number_phone'), '(222) 222 - 2222')

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/span_Create'))
...
WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/span_Send invite now'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/span_OK'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/input_Send_jss411'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_ListReports  ListReports Live/a_Start meeting'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/a_Scheduled'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  ListReports Live/a_Meeting Room'))
