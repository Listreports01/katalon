...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ListReports  Activity Feed/span_Activity Feed'), 0)

WebUI.click(findTestObject('Object Repository/Page_ListReports  Activity Feed/a_View'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  My Leads  Robin Board/p_Back to My Leads'))

WebUI.click(findTestObject('Object Repository/Page_ListReports  My Leads/button_Activity Feed'))
