...
WebUI.click(findTestObject('Object Repository/Page_Robin/button_Email me'))

WebUI.setText(findTestObject('Object Repository/Page_Robin/textarea_EmailMarbz_message'), 'test message')

WebUI.click(findTestObject('Object Repository/Page_Robin/button_Send'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Robin/div_Message sent to Marbz'), 'Message sent to Marbz.')
