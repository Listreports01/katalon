...
WebUI.click(findTestObject('Object Repository/Page_Robin/button_Interested (5)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/button_Interested (5)'), 0)
