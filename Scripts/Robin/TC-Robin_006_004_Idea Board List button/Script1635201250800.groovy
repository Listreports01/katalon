...
WebUI.click(findTestObject('Object Repository/Page_Robin/button_Idea Board'))

WebUI.click(findTestObject('Object Repository/Page_Robin/button_List'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/div_14  Marthas Way Washingtonville206  Bea_e3181c'), 
    0)
