...
WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Notifications_MuiSvgIcon-root-348'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/span_Notifications'), 0)
