...
WebUI.click(findTestObject('Object Repository/Page_Robin/button_Cancelled'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/button_Cancelled'), 0)
