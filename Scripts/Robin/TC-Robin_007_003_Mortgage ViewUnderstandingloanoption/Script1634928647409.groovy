...
WebUI.click(findTestObject('Object Repository/Page_Robin/button_Mortgage Center'))

WebUI.click(findTestObject('Object Repository/Page_Robin/a_View'))

WebUI.switchToWindowTitle('')

WebUI.navigateToUrl('https://listreports.slides.com/listreports/deck-472d37/fullscreen?token=g_6XNLPH')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Understanding loan options/section_Understanding loan options'), 
    0)
