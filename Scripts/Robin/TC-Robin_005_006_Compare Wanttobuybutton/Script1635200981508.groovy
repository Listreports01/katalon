...
WebUI.click(findTestObject('Object Repository/Page_Robin/button_Want to buy (3)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/button_Want to buy (3)'), 0)
