...
WebUI.setText(findTestObject('Object Repository/Page_Robin/input_Your searches_MuiInputBase-input-748 _08f8a6'), 'oklahoma')

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Oklahoma, PA'))

WebUI.click(findTestObject('Object Repository/Page_Robin/button_Save search'))

WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Daily_MuiSvgIcon-root-348 material-icon_1e4bd0'))

WebUI.click(findTestObject('Object Repository/Page_Robin/p_Never'))
