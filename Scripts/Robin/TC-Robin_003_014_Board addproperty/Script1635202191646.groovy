...
WebUI.setText(findTestObject('Object Repository/Page_Robin/input_Your searches_MuiInputBase-input-748 _08f8a6'), 'minneapolis')

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Minneapolis, KS'))

WebUI.click(findTestObject('Object Repository/Page_Robin/span_Pending_MuiFab-label-565'))
