...
WebUI.click(findTestObject('Object Repository/Page_Robin/button_Past'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/div_UpcomingPastCancelled'), 0)
