...
WebUI.setText(findTestObject('Object Repository/Page_Robin/input_Your searches_MuiInputBase-input-748 _08f8a6'), 'ohio')

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Ohio City - Cleveland, OH'))

WebUI.click(findTestObject('Object Repository/Page_Robin/button_Pending_MuiButtonBase-root-345 MuiFa_92b66d'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/div_Marbz FloresLic test222-222-2222'), 0)
