...
WebUI.click(findTestObject('Object Repository/Page_Robin/a_Browse Open Houses'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/div_Open Houses'), 0)
