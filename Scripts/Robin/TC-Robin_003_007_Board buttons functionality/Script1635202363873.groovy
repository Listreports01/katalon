...
WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Interested_MuiSvgIcon-root-348'))

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Days on market'))

WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Interested_MuiSvgIcon-root-348'))

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Year built'))

WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Interested_MuiSvgIcon-root-348'))

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Price (high to low)'))

WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Want to see_MuiSvgIcon-root-348'))

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Price (low to high)'))

WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Interested_MuiSvgIcon-root-348'))

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Most bedrooms'))

WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Interested_MuiSvgIcon-root-348'))

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Most bathrooms'))

WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Interested_MuiSvgIcon-root-348'))

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Most square feet'))

WebUI.click(findTestObject('Object Repository/Page_Robin/svg_Interested_MuiSvgIcon-root-348'))

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Open house'))
