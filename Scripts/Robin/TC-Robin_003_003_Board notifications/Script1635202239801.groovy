...
WebUI.click(findTestObject('Object Repository/Page_Robin/svg_MortgageCenter_MuiSvgIcon-root-348'))

WebUI.click(findTestObject('Object Repository/Page_Robin/div_Check out the new listings in your Down_f782de'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/div_Downtown Los Angeles - Los Angeles, CA _9906d1'), 
    0)
