...
WebUI.click(findTestObject('Object Repository/Page_Robin/button_Want to see (3)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Robin/div_638 S Bonnie Beach Place, East Los Ange_add2a3'), 
    0)
